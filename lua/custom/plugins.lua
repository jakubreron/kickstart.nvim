...
vim.keymap.set('n', '<leader>ra', function() require('spectre').open() end, { desc = '[a]ll' })
...
vim.keymap.set('n', 'gJ', '<cmd>TSJJoin<cr>', { desc = '[J]oin' })
vim.keymap.set('n', 'gS', '<cmd>TSJSplit<cr>', { desc = '[S]plit' })
